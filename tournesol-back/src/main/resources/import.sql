insert into adresse(id, numero_voie, code_postal) values (1, '1 rue du Général Sarrail', '33400');
...
insert into client(id, civilite, nom, telephone, portable, email, adresse_id) values (1, 'Mme', 'LAPELLEGERIE Christelle', '05 56 21 21 21', '06 12 12 12 12', 'christellelapellegerie@yahoo.fr',1);
